 ...
 */
class MainScreenAdapter(_songDetails:ArrayList<song>,context:Context): RecyclerView.Adapter<MainScreenAdapter.MyViewHolder>() {
...
if(SongPlayingFragment.statified.mediaPlayer!=null){
        ...
        (mcontext as FragmentActivity).supportFragmentManager.beginTransaction()
                .replace(R.id.details_fragment,songplayingfragment).addToBackStack("SongPlayingFragment").commit()
